...
function referenceGraph({expr, defs}: {expr: Expr, defs: Set<string>}, graph: RefGraph): Expr {
    if (expr.type == "BinOp") {
        const [[expr1, _1], [expr2, _2], opType, op, span] = expr.fields
